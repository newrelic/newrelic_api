...
Sample data:
    ...
    <metrics type="array">
      ...
      <fields type="array">
        <field>average_call_time</field>
        <field>average_response_time</field>
        <field>call_count</field>
        <field>max_call_time</field>
        <field>min_call_time</field>
        <field>requests_per_minute</field>
        <field>throughput</field>
        <field>total_call_time</field>
      </fields>
