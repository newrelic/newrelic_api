...
Sample data:
    ...
    <applications type="array">
      <application>
        ...
        <overview-url>https://api.newrelic.com/api/v1/accounts/1/applications/123</overview-url>
        <servers type="array">
          <server>
            <id type="integer">111</id>
            <hostname>host-1.example.com</hostname>
            <overview-url>https://api.newrelic.com/api/v1/accounts/1/servers/111</overview-url>
          </server>
          <server>
            <id type="integer">222</id>
            <hostname>host-2.example.com</hostname>
            <overview-url>https://api.newrelic.com/api/v1/accounts/1/servers/222</overview-url>
          </server>
        </servers>
      </application>
      <application>
        ...
        <overview-url>https://api.newrelic.com/api/v1/accounts/1/applications/124</overview-url>
        <servers type="array">
          <server>
            <id type="integer">111</id>
            <hostname>host-1.example.com</hostname>
...
Sample data:
    ...
    <servers type="array">
      <server>
        <overview-url>https://api.newrelic.com/api/v1/accounts/1/servers/555</overview-url>
        <hostname>my-hostname.newrelic.com</hostname>
        <id type="integer">555</id>
      </server>
      <server>
        <overview-url>https://api.newrelic.com/api/v1/accounts/1/servers/556</overview-url>
...
Sample data:
    ...
    <hosts type="array">
      <host>
        <overview-url>https://api.newrelic.com/api/v1/accounts/1/applications/123_h3333</overview-url>
...
Sample data:
    ...
    <instances type="array">
      <instance>
        <overview-url>https://api.newrelic.com/api/v1/accounts/1/applications/123/instances/1441_i7584</overview-url>
        <name>App name (my-hostname.newrelic.com)</name>
        <id>1441_i7584</id>
      </instance>
    </instances>
