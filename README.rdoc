...
URL::  <code>https://api.newrelic.com/api/v1/applications/:app_id/metrics.:format</code>   Replace <tt>:app_id</tt> and <tt>:format</tt> with the application ID and for format use one of (json, xml, csv).
Method::    GET
Restrictions::   This API should be called at most once per minute.
...
URL::  <code>https://api.newrelic.com/api/v1/applications/:app_id/data.:format</code>   Replace <tt>:app_id</tt> and <tt>:format</tt> with the application ID and for format use one of (json, xml, csv).
Method::    GET
...
https://api.newrelic.com/api/v1/applications/APPLICATION_ID/data.xml?start=2011-04-20T15:47:19Z&end=2011-04-20T15:52:19Z&metrics[]=ActiveRecord/all&field=average_response_time
...
https://api.newrelic.com/api/v1/applications/APPLICATION_ID/data.xml?start=2011-04-20T15:47:19Z&end=2011-04-20T15:52:19Z&metrics[]=ActiveRecord/all&field=average_response_time&summary=1
