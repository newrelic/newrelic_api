...
Sample data:
    ...
    <servers type="array">
      <server>
        <overview-url>https://staging.newrelic.com/accounts/1/servers/123</overview-url>
        <hostname>my-hostname.newrelic.com</hostname>
        <id type="integer">123</id>
      </server>
      <server>
        <overview-url>https://staging.newrelic.com/accounts/1/servers/124</overview-url>
