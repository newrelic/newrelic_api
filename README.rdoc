...
You can see this in the browser URL when you log in to api.newrelic.com.

=== Data Returned

For each application, a list of associated servers is provided.
The list of servers is empty if you do not use server monitoring.
...
Sample data:
    ...
    <applications type="array">
      <application>
        ...
        <overview-url>https://api.newrelic.com/accounts/1/applications/123</overview-url>
        <servers type="array">
          <server>
            <id type="integer">111</id>
            <hostname>host-1.example.com</hostname>
            <overview-url>https://dev.newrelic.com/accounts/1/servers/111</overview-url>
          </server>
          <server>
            <id type="integer">222</id>
            <hostname>host-2.example.com</hostname>
            <overview-url>https://dev.newrelic.com/accounts/1/servers/222</overview-url>
          </server>
        </servers>
      </application>
      <application>
        ...
        <overview-url>https://dev.newrelic.com/accounts/1/applications/124</overview-url>
        <servers type="array">
          <server>
            <id type="integer">111</id>
            <hostname>host-1.example.com</hostname>
...
URL::            <code>https://api.newrelic.com/accounts/:account_id/application_settings.xml</code>
Method::         GET
Restrictions::   None
...
URL::            <code>https://api.newrelic.com/accounts/:account_id/application_settings/:app_id.xml</code>
Method::         GET
Restrictions::   None
...
URL::            <code>https://api.newrelic.com/accounts/:account_id/applications/:app_id/thresholds.xml</code>
Method::         GET
Restrictions::   None
...
URL::            <code>https://api.newrelic.com/accounts/:account_id/applications/:app_id/thresholds/:id.xml</code>
Method::         GET
Restrictions::   None
...
* +caution_value+: Exceeding this value for an extended period results in the creation of a caution event.
  For Apdex, a value from 0 to 1.0 should be specified.
  For error rate, a percentage between 0 and 100 should be specified. 
...
when you log in to api.newrelic.com and navigate to the server you want to delete.
...
URL::            <code>https://api.newrelic.com/accounts/:account_id/server_settings.xml</code>
Method::         GET
Restrictions::   None
...
URL::            <code>https://api.newrelic.com/accounts/:account_id/server_settings/:server_id.xml</code>
Method::         GET
Restrictions::   None
...
URL::            <code>https://api.newrelic.com/accounts/:account_id/servers/:server_id/thresholds.xml</code>
Method::         GET
Restrictions::   None
...
URL::            <code>https://api.newrelic.com/accounts/:account_id/servers/:server_id/thresholds/:id.xml</code>
Method::         GET
Restrictions::   None
...
URL::            <code>https://api.newrelic.com/accounts/:account_id/users.xml</code>
Method::         GET
Restrictions::   None
...
URL::            <code>https://api.newrelic.com/accounts/:account_id/users/:id.xml</code>
Method::         GET
Restrictions::   None
...
URL::            <code>https://api.newrelic.com/accounts/:account_id/users/:user_id/alert_settings.xml</code>
Method::         GET
Restrictions::   None
...
URL::            <code>https://api.newrelic.com/accounts/:account_id/users/:user_id/alert_settings/:id.xml</code>
Method::         GET
Restrictions::   None
...
URL::  <code>https://api.newrelic.com/accounts/:account_id/applications/:app_id/threshold_values.xml</code>
